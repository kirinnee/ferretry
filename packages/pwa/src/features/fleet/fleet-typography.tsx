/**
 * The two presentation decisions this panel kept getting wrong, in one place.
 *
 ...
 * the app, and a fleet-only constant would be a fifth vocabulary for something the whole PWA already
 * spells inline.
 */
 ...
 * in this panel already has, which is the convention this follows rather than inventing a second one. The
 * value is never LOST by the clipping: the text is complete in the DOM so a screen reader reads all of
