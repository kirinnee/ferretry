...
describe('BunGitRunner', () => {
  ...
  it('should expose conservative default limits', () => {
    // Act + Assert
  ...
  it('should run a command in the requested checkout and report success', async () => {
    // Arrange
  ...
  it('should surface the exit code and stderr instead of swallowing a failure', async () => {
    // Arrange
  ...
  it('should pass arguments through without any shell interpretation', async () => {
  ...
  it('should cap stdout and mark the result truncated', async () => {
    // Arrange
  ...
  it('should keep nothing at all when the stdout budget is zero', async () => {
    // Arrange
  ...
  ])('should refuse an invalid $label rather than spawn Git', async ({ invocation, message }) => {
    // Arrange
  ...
  it('should kill a command that outlives its timeout and report it as timed out', async () => {
  ...
  it('should fail loudly when Git cannot be started at all', async () => {
    // Arrange
  ...
  it('should scrub inherited GIT_* variables while keeping the rest of the environment', async () => {
  ...
  it('should pin a machine-readable locale and quoting for parseable output', async () => {
  ...
  it('should refuse to run repository hooks or a configured pager', async () => {
    // Arrange
