...
| Settings for text size, density, chat width, composer Markdown, themes, dictation, notifications, PWA identity, and Warden link | PORTED device settings: `packages/pwa/src/features/settings/settings-page.tsx`; PORTED daemon-owned frame and Warden tab: `features/settings/daemon-settings-frame.tsx`.                                                                                                                                                    |
