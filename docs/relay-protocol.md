...
| ------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| the daemon dropped a relay the client still holds | the handshake finds no daemon at that rendezvous and the client advances. Not an error — a miss. The stale entry is pruned by the refresh after the next successful connection. |
